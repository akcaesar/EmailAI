"""
  Author: Akshay NS
  Contains: Email fetching tool for IMAP servers with enhanced error handling and
...
class EmailFetchTool:
      ...
      async def _fetch_single_email(self, mail_id: str) -> Optional[EmailMessage]:
          ...
          try:
              ...
              # Extract UID - fix this part
              uid_str = mail_id.decode('utf-8') if isinstance(mail_id, bytes) else str(mail_id)
